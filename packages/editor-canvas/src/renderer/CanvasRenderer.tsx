import type { NodeData, DocumentNode, Position, Size, ComponentDefinition, InstanceNode } from '@design-editor/core';
...
function renderInstance(
  ...
  if (!component) {
    ...
    return (
      <div style={{ ...instance.style, background: '#ff000033', border: '1px dashed red' }}>
        Missing Component
      </div>
    );
  }
